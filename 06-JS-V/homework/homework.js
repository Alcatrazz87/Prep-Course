...
function agregarStringInvertida() {
  ...
  for(var i = this.length - 1; i>=0; i--) {stringInvertida = stringInvertida + this.charAt(i)};
...
// ---------------------------------------------------------------------------//
  ...
  class Persona {
  constructor(nombre, apellido, edad, domicilio) {this.nombre = nombre, this.apellido = apellido; this.edad =edad, this.domicilio =domicilio
